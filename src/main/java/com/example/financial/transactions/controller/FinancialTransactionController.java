...
import com.example.financial.transactions.repository.FinancialTransactionsRepository;
...
public class FinancialTransactionController {
    ...
    @Autowired
    public FinancialTransactionController(StorageService storageService) {
