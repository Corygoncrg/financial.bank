...
import com.example.transactions.kafka.KafkaResponseHandler;
...
class TransactionServiceTest {
    ...
    void csvFileUpload4() throws JsonProcessingException, InterruptedException {
        JsonStringWrapper jsonMessage = new JsonStringWrapper();
        ...
        verify(kafkaTemplate).send("FINANCIAL_BANK_TRANSACTIONS_REQUEST", jsonMessage);
    }
